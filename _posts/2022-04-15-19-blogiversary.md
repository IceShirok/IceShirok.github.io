...
While the human body, and really any living being, is a marvel on its complexity. While the body does a pretty good job fixing itself and adapting to various stimuli, it's not perfect. *Why are there sometimes unintentional side effects in prescription drugs? Why do allergens cause allergies in some people but not others?* They all have to do with the communication breakdown in our bodies, resulting in homeostasis going awry as well. Let's see some examples of how various scenarios involving receptors can cause disease.

P.S. I've done some research on why certain human foods are toxic to pets. Turns out that, [for dogs and chocolate, this is a metabolism issue](https://vcahospitals.com/know-your-pet/chocolate-poisoning-in-dogs)! Dogs don't have the enzymes to breakdown caffeine and theobromine as quickly as humans, so they're at greater risk of a lethal buildup.

#### Communication is key - in cells too

Did you know that cells can communicate? In fact, it is part of [the essential aspects of living beings](https://bio.libretexts.org/Bookshelves/Introductory_and_General_Biology/Book%3A_Introductory_Biology_(CK-12)/01%3A_Introduction_to_Biology/1.04%3A_Characteristics_of_Life) - living beings are able to take sensory input of the outside world, perform certain (internal) actions involving complex chemical processes, and react accordingly.

This is the same in tech. For example, clicking a button on a webpage triggers a cascade of actions. Externally, the webpage is redirected to a new page with a successful response. Internally, many other things are happening. Logging, sending metrics, saving data in a database or a cookie, triggering events, sending events to external systems, etc. (In fact, the [idea of cognitive psychology](https://www.simplypsychology.org/cognitive.html) derives from the advent of computers, with the idea that the mind has an internal state that changes with input, but we're diverging from the topic at hand.)

Cells have receptors that bind to a specific ligand with [a very specific shape in a "lock-and-key" fashion](https://www.biologyonline.com/dictionary/lock-and-key-model). A bound receptor triggers one of three signaling pathways or cascades: 1) amplification of the signal, 2) gene expression, or 3) terminating a signal. In reality, these [signaling cascades can get very, very complicated](https://www.khanacademy.org/science/ap-biology/cell-communication-and-cell-cycle/changes-in-signal-transduction-pathways/a/intracellular-signal-transduction) with the assortment of ligands, enzymes, and receptors that can be involved.

<div style="text-align:center"><img src="/images/blog19/blog19-signaling-cascade.JPG" width="350"></div>

[Bacteria can form biofilms](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC2732559/) to increase their collective survival by surrounding themselves in a protective slime layer and sharing resources. They are able to coordinate the collective action through [quorum sensing](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC3543102/) (for the tech-saavy, not unlike [peer-to-peer networking](https://www.lifewire.com/p2p-networking-and-software-818019)).

In contrast, a living organism is like a massive ecosystem of specialized systems working together (for the tech-saavy, something like a complex, distributed fleet of services).
* Some problems, such as a small cut on the skin, can be handled locally (inflammation, recruiting white blood cells to handle infection, clotting, etc).
* Other problems require coordination of multiple organ systems. These organ systems can be [rapidly signalled through the nervous system, or slowly messaged through the endocrine system](https://www.khanacademy.org/science/high-school-biology/hs-human-body-systems/hs-the-nervous-and-endocrine-systems/a/hs-the-nervous-and-endocrine-systems-review). For example, the [fight-or-flight response](https://www.physio-pedia.com/Sympathetic_Nervous_System) is a good example of how multiple organ systems are coordinated to get a person's body ready to respond to a threat - more oxygen (respiratory), more energy to the muscles (muscular), enlarged pupils (sensory), and suppressed hunger (digestive).

#### Communication gone awry - pathogens

**Pathogens can be identified by "antigens"**, which the immune system can "remember" to defend against in a future infection with a faster response. Immune cells build up receptors that adapt specifically to the antigen. Pathogens (which can be bacterial or viral) can [rapidly change their antigens so that they can no longer be bound to the receptor](https://www.cdc.gov/flu/about/viruses/change.htm). The immune system considers this pathogen a "new" invader and has to spend time building up a new response. This gives the pathogen more time to infect and wreck havoc.
...
**Type 2 diabetes** is caused by "insulin resistance", or that body cells don't respond to the signal of insulin in the bloodstream. Because the body cells' receptors don't respond to insulin as well, they don't know to start taking glucose from the bloodstream, and thus blood sugar can remain at a dangerously high level. However, [the exact mechanism why insulin resistance occurs is currently insanely complex](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC3941218/).
