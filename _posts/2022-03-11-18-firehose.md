...
To hide the cover photo for this blog, enjoy a derp cat who loves shoes.
...
Now I'm happy to be joining [Vault Health](https://www.vaulthealth.com) as a Senior Software Engineer (TM). It's been a heck of a month within the company so far, getting to learn about the tech stack, the business goals, and the culture. It's been plenty of breaks during the weekdays, and a lot of rest and respite with the cat on weeknights.
...
DNA is **transcribed** into mRNA, which are used to produce proteins. Why have this intermediary step? [DNA is a very, very precious resource](https://courses.lumenlearning.com/wmopen-biology1/chapter/cell-cycle-checkpoints/), so it resides in the nucleus. mRNA is a copy of DNA that can be destroyed so that only the right number of proteins are produced. [mRNA is also processed with protective measures](https://www.khanacademy.org/science/ap-biology/gene-expression-and-regulation/transcription-and-rna-processing/a/eukaryotic-pre-mrna-processing) so that it can be differentiated from foreign genetic material, such as bacterial or viral RNA.
