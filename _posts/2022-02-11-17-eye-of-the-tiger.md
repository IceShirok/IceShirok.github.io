...
Depends on who you ask. Let’s talk about the biological science definition. "Metabolism" is considered [the sum of all biochemical reactions in our body](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC7545035/). What does that mean?

My chemistry professor described the basis of chemistry as relationships between molecules - the formation and breaking between atoms and molecules to form a new set of chemicals. Breaking bonds release energy, while forming bonds require energy. The cells in our bodies work to grab such molecules, break them into useful components and energy, then use the same components and energy to build bigger molecules. The cells require these macromolecules to keep themselves well-maintained. This, in turn, helps maintain the organs in our bodies that help [streamline the process of absorbing nutrients, building and maintaining the body, and getting rid of the garbage](https://www.niddk.nih.gov/health-information/digestive-diseases/digestive-system-how-it-works).
...
We’ll focus on the (human) cell again. Cells that perform [cellular respiration](https://www.khanacademy.org/science/ap-biology/cellular-energetics/cellular-respiration-ap/a/intro-to-cellular-respiration-and-redox) typically take in glucose (a sugar) and oxygen. Through cellular respiration, cells produce carbon dioxide, water, and energy. Sounds familiar? We also eat carbs and breathe in oxygen, and we produce carbon dioxide and energy as a result!
...
The electron carriers then bring those electrons into the **Electron Transport Chain**. The electrons get pulled through the chain and help to power a turbine-like enzyme called ATP synthase, which produces ATP - the "energy currency" of the cell. It's not unlike a dam, where the falling water causes the turbine to turn, producing electrical energy in the process.
...
Similarly, many organisms on the Earth produce their own energy in different ways than humans.
* The yeast used to produce [beer](https://grainfather.com/beer-fermentation-process/) and bread use a process called [fermentation alongside glycolysis](https://www.chem.purdue.edu/courses/chm333/images/Fermentation%20Pyruvate.pdf).
* Some bacteria, such as the ones that cause [botulism](https://www.cdc.gov/botulism/index.html), cannot survive with oxygen - and is a major issue in tightly-sealed canned foods.
* [Bacteria and algae](https://oceanservice.noaa.gov/facts/phyto.html) in the sunnier parts of the ocean can survive in salty waters and collect energy from the sun.
* Bacteria can also [live around hydrothermal vents deep in the sea](https://ocean.si.edu/ecosystems/deep-sea/microbes-keep-hydrothermal-vents-pumping), using sulfur and other inorganic chemicals as a way to respire.
